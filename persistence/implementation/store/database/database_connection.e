...
feature -- Database Setup
	...
	db_application: DATABASE_APPL [DATABASE]
			...
			--| This object, enable the program logs into the database and initializes a database handle.

	db_control: DB_CONTROL
			-- Database control.
			--| This object allows the program to connect to the database, handle errors, and disconnect.
