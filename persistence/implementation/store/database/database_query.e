...
feature {NONE} -- Intialization
	...
	make_query (a_query: STRING; a_parameters: like parameters)
			-- Create SQL  query `a_query' with arguments `a_parameters'
		do
			write_information_log (generator + ".make_query: " + a_query)
			write_debug_log (generator + ".make_query" + " arguments:" + log_parameters (a_parameters))
			query := a_query
